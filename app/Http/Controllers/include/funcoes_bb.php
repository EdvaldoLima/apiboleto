...
// $dadosboleto["codigo_barras"] está sendo passado no lugar de
// $linha para adaptar o código para a carteira 17 com 7 posições
// Subsituir as duas próximas linhas para "normalizar" o código
$dadosboleto["codigo_barras"] = $dadosboleto["codigo_barras"];
$dadosboleto["linha_digitavel"] = monta_linha_digitavel($dadosboleto["codigo_barras"]);
...
//Guarda inicial
?><img src=<?php echo asset('/imagens/p.png'); ?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo asset('/imagens/b.png'); ?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo asset('/imagens/p.png'); ?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo asset('/imagens/b.png'); ?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=<?php echo asset('/imagens/p.png'); ?> width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=<?php echo asset('/imagens/b.png'); ?> width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=<?php echo asset('/imagens/p.png'); ?> width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=<?php echo asset('/imagens/b.png'); ?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo asset('/imagens/p.png'); ?> width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da fun��o
